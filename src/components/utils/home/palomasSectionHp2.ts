...
export const palomasSectionHp2 = [
  ...
  { id: 2, titulo: 'Familias Protegidas', texto: 'Nuestra misión principal', img: icono2 },
  { id: 3, titulo: 'Crecimiento Integral', texto: 'Expertos en bienestar', img: icono3 },
  { id: 4, titulo: 'Cobertura Nacional', texto: 'Presencia en todo México', img: icono4 },
];
